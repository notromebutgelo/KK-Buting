...
export async function getDigitalId(uid: string) {
  ...
  return {
    ...
    digitalIdApprovedAt: toIso(data.digitalIdApprovedAt),
    digitalIdStatus: resolvedDigitalIdStatus,
...
export async function getMyVerificationStatus(uid: string) {
  ...
  return {
    ...
    digitalIdGeneratedAt: toIso(profile.digitalIdGeneratedAt),
    digitalIdApprovedAt: toIso(profile.digitalIdApprovedAt),
